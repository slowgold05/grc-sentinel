...
def insert_determinations(
    connection: Connection,
    org_id: UUID,
    engagement_id: UUID,
    determinations: list[Determination],
) -> int:
    """Append determinations through an existing tenant-scoped transaction."""
    stored = 0
...
def store_determinations(
    ...
    with engine.begin() as connection:
        ...
        return insert_determinations(connection, org_id, engagement_id, determinations)
