...
const controls = [
  ...
  { id: "SA-11", title: "Developer Testing and Evaluation", status: "Implemented", evidence: "CI runs tests, type checks, dependency audits, Bandit, Semgrep, and secret scanning. The current backend suite contains 95 passing tests." },
    ...
    <main className="min-h-screen bg-black px-5 py-10 text-slate-100 sm:px-8 lg:py-16">
      <div className="mx-auto max-w-[1600px]">
        ...
        <header className="mt-10 border-b border-zinc-800 pb-10">
          <p className="text-xs font-semibold uppercase tracking-[0.24em] text-red-500">GRC Sentinel trust center</p>
