...
export default function Home() {
  return <main className="landing-page">
    ...
    <section className="product-showcase" id="platform" aria-labelledby="showcase-heading">
      <div className="marketing-container showcase-frame"><header className="section-intro"><p className="hero-eyebrow">THE SENTINEL GRC PLATFORM</p><h2 id="showcase-heading">Your requirements. Your AI.<br />The evidence that connects them.</h2><p>See how the work fits together, before you create an account.</p></header>
