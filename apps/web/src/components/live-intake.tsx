  ...
  return (
    <section className="mb-10 rounded-2xl border border-red-500/20 bg-red-500/[0.04] p-6" aria-labelledby="new-engagement">
      ...
      <form onSubmit={submit} className="mt-5 grid gap-3 sm:grid-cols-3">
        ...
        <fieldset className="grid gap-2 rounded-lg border border-zinc-700 p-3 sm:col-span-3"><legend className="px-2 text-sm font-semibold text-red-400">Other confirmed regulatory scope facts</legend><div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3"><label className="flex items-center gap-2 text-sm"><input name="sox" type="checkbox" /> Exchange Act reporting company</label><label className="flex items-center gap-2 text-sm"><input name="dora" type="checkbox" /> DORA-covered EU financial entity</label><label className="flex items-center gap-2 text-sm"><input name="mas_trm" type="checkbox" /> Subject to an MAS TRM Notice</label></div></fieldset>
